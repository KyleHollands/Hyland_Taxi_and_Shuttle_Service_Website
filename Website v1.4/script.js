document.addEventListener("DOMContentLoaded", () => {
    ...
    toggleButton.addEventListener('click', () => {
        const isFaresView = toggleImage.src.includes('scheduleV7.png');
        toggleImage.src = isFaresView ? 'images/faresV7.png' : 'images/scheduleV7.png';
        toggleButton.textContent = isFaresView ? 'Show Schedule' : 'Show Fares';
    });
